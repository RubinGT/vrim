...
const CHARACTER_ROSTER: Character[] = [
  { name: 'Adam Warlock', defaultImage: 'https://static.dotgg.gg/rivals/characters/adam-warlock-portrait.webp', challenges: ["No primary fire (Soul Bond beam) - healing only"] },
  { name: 'Black Panther', defaultImage: 'https://static.dotgg.gg/rivals/characters/black-panther-portrait.webp', challenges: ["No Vibranium Claws (primary attack) - abilities only"] },
  { name: 'Black Widow', defaultImage: 'https://static.dotgg.gg/rivals/characters/black-widow-portrait.webp', challenges: ["No Widow's Kiss (primary fire) - melee and abilities only"] },
  { name: 'Captain America', defaultImage: 'https://static.dotgg.gg/rivals/characters/captain-america-portrait.webp', challenges: ["No Liberty Rush (dash) - static positioning only"] },
  { name: 'Cloak & Dagger', defaultImage: 'https://static.dotgg.gg/rivals/characters/cloak-dagger-portrait.webp', challenges: ["No healing abilities - damage only"] },
  { name: 'Doctor Strange', defaultImage: 'https://static.dotgg.gg/rivals/characters/doctor-strange-portrait.webp', challenges: ["No Eye of Agamotto (ultimate) entire match"] },
  { name: 'Emma Frost', defaultImage: 'https://static.dotgg.gg/rivals/characters/emma-frost-portrait.webp', challenges: ["No Psychic Orb (primary fire) - diamond form combat only"] },
  { name: 'Groot', defaultImage: 'https://static.dotgg.gg/rivals/characters/groot-portrait.webp', challenges: ["No Ironbark Wall AND no Flora Colossus (both defensive abilities)"] },
  { name: 'Hawkeye', defaultImage: 'https://static.dotgg.gg/rivals/characters/hawkeye-portrait.webp', challenges: ["No Hunter's Sight (wallhack ability) - blind shooting only"] },
  { name: 'Hela', defaultImage: 'https://static.dotgg.gg/rivals/characters/hela-portrait.webp', challenges: ["No Goddess of Death (ultimate) AND no Astral Flock"] },
  { name: 'Hulk', defaultImage: 'https://static.dotgg.gg/rivals/characters/bruce-banner-portrait.webp', challenges: ["No Incredible Hulk (ultimate) entire match"] },
  { name: 'Human Torch', defaultImage: 'https://static.dotgg.gg/rivals/characters/human-torch-portrait.webp', challenges: ["No flight ability - ground movement only"] },
  { name: 'Invisible Woman', defaultImage: 'https://static.dotgg.gg/rivals/characters/invisible-woman-portrait.webp', challenges: ["No invisibility AND no force fields"] },
  { name: 'Iron Fist', defaultImage: 'https://static.dotgg.gg/rivals/characters/iron-fist-portrait.webp', challenges: ["No K'un-Lun Kick (mobility) - walking only"] },
  { name: 'Iron Man', defaultImage: 'https://static.dotgg.gg/rivals/characters/iron-man-portrait.webp', challenges: ["No flight AND no Armor Overdrive - ground combat only"] },
  { name: 'Jeff the Land Shark', defaultImage: 'https://static.dotgg.gg/rivals/characters/jeff-the-land-shark-portrait.webp', challenges: ["No It's Jeff! (ultimate) entire match"] },
  { name: 'Loki', defaultImage: 'https://static.dotgg.gg/rivals/characters/loki-portrait.webp', challenges: ["No Illusion Projection AND no God of Mischief (ultimate)"] },
  { name: 'Luna Snow', defaultImage: 'https://static.dotgg.gg/rivals/characters/luna-snow-portrait.webp', challenges: ["No Absolute Zero (ultimate) entire match"] },
  { name: 'Magik', defaultImage: 'https://static.dotgg.gg/rivals/characters/magik-portrait.webp', challenges: ["No Soul Sword summoning - limbo abilities only"] },
  { name: 'Magneto', defaultImage: 'https://static.dotgg.gg/rivals/characters/magneto-portrait.webp', challenges: ["No Mag-Lev (flight) - ground positioning only"] },
  { name: 'Mantis', defaultImage: 'https://dotgg.gg/rivals/characters/mantis-portrait.webp', challenges: ["No Life Energy (healing beam) - sleep abilities only"] },
  { name: 'Mister Fantastic', defaultImage: 'https://static.dotgg.gg/rivals/characters/mister-fantastic-portrait.webp', challenges: ["No Elastic Punch (primary fire) - stretch abilities only"] },
  { name: 'Moon Knight', defaultImage: 'https://static.dotgg.gg/rivals/characters/moon-knight-portrait.webp', challenges: ["No Crescent Dart AND no Hand of Khonshu (ultimate)"] },
  { name: 'Namor', defaultImage: 'https://static.dotgg.gg/rivals/characters/namor-portrait.webp', challenges: ["No Trident of Neptune AND no Blessing of the Deep"] },
  { name: 'Peni Parker', defaultImage: 'https://static.dotgg.gg/rivals/characters/peni-parker-portrait.webp', challenges: ["No SP//dr Mech ultimate entire match"] },
  { name: 'Phoenix', defaultImage: 'https://static.dotgg.gg/rivals/characters/phoenix-portrait.webp', challenges: ["No Phoenix Force (ultimate) entire match"] },
  { name: 'Psylocke', defaultImage: 'https://static.dotgg.gg/rivals/characters/psylocke-portrait.webp', challenges: ["No Psychic Blade AND no Telekinetic Katana (ultimate)"] },
  { name: 'The Punisher', defaultImage: 'https://static.dotgg.gg/rivals/characters/the-punisher-portrait.webp', challenges: ["No Peacemaker (ultimate) entire match"] },
  { name: 'The Thing', defaultImage: 'https://static.dotgg.gg/rivals/characters/the-thing-portrait.webp', challenges: ["No Clobberin' Time (ultimate) entire match"] },
  { name: 'Rocket Raccoon', defaultImage: 'https://static.dotgg.gg/rivals/characters/rocket-raccoon-portrait.webp', challenges: ["No Rocket's Big Boom (ultimate) entire match"] },
  { name: 'Scarlet Witch', defaultImage: 'https://static.dotgg.gg/rivals/characters/scarlet-witch-portrait.webp', challenges: ["No Reality Erasure (ultimate) entire match"] },
  { name: 'Squirrel Girl', defaultImage: 'https://static.dotgg.gg/rivals/characters/squirrel-girl-portrait.webp', challenges: ["No Squirrel Swarm AND no Girl, Squirrel! (ultimate)"] },
  { name: 'Spider-Man', defaultImage: 'https://static.dotgg.gg/rivals/characters/spider-man-portrait.webp', challenges: ["No Spectacular Spin (ultimate) AND no Web-Swing"] },
  { name: 'Star-Lord', defaultImage: 'https://static.dotgg.gg/rivals/characters/star-lord-portrait.webp', challenges: ["No Galactic Legend (ultimate) entire match"] },
  { name: 'Storm', defaultImage: 'https://static.dotgg.gg/rivals/characters/storm-portrait.webp', challenges: ["No Omega-Level Storm (ultimate) entire match"] },
  { name: 'Thor', defaultImage: 'https://static.dotgg.gg/rivals/characters/thor-portrait.webp', challenges: ["No God of Thunder (ultimate) entire match"] },
  { name: 'Ultron', defaultImage: 'https://static.dotgg.gg/rivals/characters/ultron-portrait.webp', challenges: ["No Evolutionary Armor (ultimate) entire match"] },
  { name: 'Venom', defaultImage: 'https://static.dotgg.gg/rivals/characters/venom-portrait.webp', challenges: ["No Symbiotic Resilience (ultimate) entire match"] },
  { name: 'Winter Soldier', defaultImage: 'https://static.dotgg.gg/rivals/characters/winter-soldier-portrait.webp', challenges: ["No Winter Protocol (ultimate) entire match"] },
  { name: 'Wolverine', defaultImage: 'https://static.dotgg.gg/rivals/characters/wolverine-portrait.webp', challenges: ["No Primal Instincts (ultimate) entire match"] },
